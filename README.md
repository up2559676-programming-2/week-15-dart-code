...
Navigate to the directory containing the code with the `cd` command, see below for an example. For more information, refer to [these step-by-step instructions]([https://sl.bing.net/jg0O1D00KaW](https://chatgpt.com/share/67b54ef5-e9bc-8013-bf14-a0cbede90e95)).
